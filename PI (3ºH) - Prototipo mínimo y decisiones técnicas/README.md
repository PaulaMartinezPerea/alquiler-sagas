...
1. **Frontend + BD:** Entrar a `http://localhost:3000` mostrará la interfaz del proyecto confirmando la conexión a la base de datos (Temporal).
2. **Persistencia:** Ejecutar `npx prisma studio` visualizará las tablas creadas en el puerto 5555.